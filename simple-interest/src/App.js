    ...
    <div className='d-flex justify-content-center align-items-center w-100 mt-5' style={{height:"90vh"}}>
      ...
      <form action=''className='mt-5' onSubmit={(e)=> handleSubmit(e)}>
        ...
        <Stack direction="row" spacing={2}>
          <Button  style={{height:"50px",width:"200px"}} variant="contained" className='bg-success'type='Submit' typeof='submit'>CALCULATE</Button>
          <Button style={{height:"50px",width:"200px"}} variant="contained" className='bg-grey'onClick={clearValues}>RESET</Button>
          </Stack>
        </div>
      </form>
    </div>
